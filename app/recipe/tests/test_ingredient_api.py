...
class PrivateIngredientApiTests(TestCase):
    """test for the private ingredient endpoints"""
    ...
    def test_retrive_ingredcient_list(self):
    ...
    def test_create_ingredient_successful(self):
        """test creating ingredint successfully"""
        payload = {
    ...
    def test_create_ingredient_invalid(self):
        """test that can't create a new ingredient with invalid request"""
        payload = {
            'name': ''
        }
